            ...
            var n = {
                ...
                data: {
                    labels: ["فروردین",
                        ...
                        "اسفند"],
                    datasets: [{
                        label: "", borderColor: t, borderWidth: i, pointHoverRadius: 4, pointHoverBorderWidth: 12, pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), fill: !1, data: a
                    }
                    ]
                }
                ,
        ...
        init: function () {
            ...
            !function () {
                ...
                if (e) {
                    var a = {
                        labels: ["Label 1",
                            ...
                            "Label 16"],
                        datasets: [{
                            backgroundColor: KTApp.getStateColor("success"), data: [15, 20, 25, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20]
                        }
                            ,
                        {
                ...
                function () {
                    if (KTUtil.getByID("kt_chart_profit_share")) {
                        var e = {
                            ...
                            data: {
                                datasets: [{
                                    data: [35, 30, 35], backgroundColor: [KTApp.getStateColor("success"), KTApp.getStateColor("danger"), KTApp.getStateColor("brand")]
                                }
                                ],
                                labels: ["Angular",
                                    "CSS",
                            ...
                            options: {
                                ...
                                ,
                                tooltips: {
                                    enabled: !0, intersect: !1, mode: "nearest", bodySpacing: 5, yPadding: 10, xPadding: 10, caretPadding: 0, displayColors: !1, backgroundColor: KTApp.getStateColor("brand"), titleFontColor: "#ffffff", cornerRadius: 4, footerSpacing: 0, titleSpacing: 0
                                }
                            }
                        }
                            ,
                ...
                function () {
                        ...
                        var e = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "April"],
                                datasets: [{
                                    label: "Sales Stats", borderColor: KTApp.getStateColor("brand"), borderWidth: 2, backgroundColor: KTApp.getStateColor("brand"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color(KTApp.getStateColor("danger")).alpha(.2).rgbString(), data: [10, 20, 16, 18, 12, 40, 35, 30, 33, 34, 45, 40, 60, 55, 70, 65, 75, 62]
                                }
                                ]
                            }
                            ,
                    ...
                    (),
                e($("#kt_chart_sales_by_apps_1_1"), [10, 20, -5, 8, -20, -2, -4, 15, 5, 8], KTApp.getStateColor("success"), 2),
                e($("#kt_chart_sales_by_apps_1_2"), [2, 16, 0, 12, 22, 5, -10, 5, 15, 2], KTApp.getStateColor("danger"), 2),
                e($("#kt_chart_sales_by_apps_1_3"), [15, 5, -10, 5, 16, 22, 6, -6, -12, 5], KTApp.getStateColor("success"), 2),
                e($("#kt_chart_sales_by_apps_1_4"), [8, 18, -12, 12, 22, -2, -14, 16, 18, 2], KTApp.getStateColor("warning"), 2),
                e($("#kt_chart_sales_by_apps_2_1"), [10, 20, -5, 8, -20, -2, -4, 15, 5, 8], KTApp.getStateColor("danger"), 2),
                e($("#kt_chart_sales_by_apps_2_2"), [2, 16, 0, 12, 22, 5, -10, 5, 15, 2], KTApp.getStateColor("dark"), 2),
                e($("#kt_chart_sales_by_apps_2_3"), [15, 5, -10, 5, 16, 22, 6, -6, -12, 5], KTApp.getStateColor("brand"), 2),
                e($("#kt_chart_sales_by_apps_2_4"), [8, 18, -12, 12, 22, -2, -14, 16, 18, 2], KTApp.getStateColor("info"), 2),
                function () {
                            ...
                            a = {
                                ...
                                data: {
                                    labels: ["January",
                                        ...
                                        "October"],
                                    datasets: [{
                                        label: "Sales Stats", backgroundColor: KTApp.getStateColor("danger"), borderColor: KTApp.getStateColor("danger"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("success"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                                    }
                                    ]
                                }
                                ,
                        ...
                        var t = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "April"],
                                datasets: [{
                                    label: "Sales Stats", backgroundColor: a, borderColor: "#0dc8de", pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [20, 10, 18, 15, 26, 18, 15, 22, 16, 12, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 21, 21, 13, 15, 22, 24, 21, 11, 14, 19, 21, 17]
                                }
                                ]
                            }
                            ,
                            ...
                            a = {
                                ...
                                data: {
                                    labels: ["January",
                                        ...
                                        "April"],
                                    datasets: [{
                                        label: "Sales Stats", backgroundColor: "#d2f5f9", borderColor: KTApp.getStateColor("brand"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21, 17]
                                    }
                                    ]
                                }
                                ,
                ...
                function () {
                    if (0 != $("#kt_chart_latest_trends_map").length) try {
                        new GMaps({
                            div: "#kt_chart_latest_trends_map", lat: -12.043333, lng: -77.028333
                        }
                        )
                    }
                        catch (e) {
                ...
                0 != $("#kt_chart_revenue_change").length && Morris.Donut({
                    element: "kt_chart_revenue_change", data: [{
                ...
                0 != $("#kt_chart_support_tickets").length && Morris.Donut({
                    element: "kt_chart_support_tickets", data: [{
                    ...
                    ], labelColor: "#a7a7c2", colors: [KTApp.getStateColor("success"), KTApp.getStateColor("brand"), KTApp.getStateColor("danger")]
                }
                ),
                function () {
                ...
                function () {
                    if (0 != $("#kt_chart_activities").length) {
                        var e = document.getElementById("kt_chart_activities").getContext("2d"),
                            a = e.createLinearGradient(0, 0, 0, 240);
                        ...
                        var t = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "October"],
                                datasets: [{
                                    label: "Sales Stats", backgroundColor: Chart.helpers.color("#e14c86").alpha(1).rgbString(), borderColor: "#e13a58", pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("light"), pointHoverBorderColor: Chart.helpers.color("#ffffff").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                                }
                                ]
                            }
                            ,
                        ...
                        var t = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "October"],
                                datasets: [{
                                    label: "Bandwidth Stats", backgroundColor: a, borderColor: KTApp.getStateColor("success"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                                }
                                ]
                            }
                            ,
                        ...
                        var t = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "October"],
                                datasets: [{
                                    label: "Bandwidth Stats", backgroundColor: a, borderColor: KTApp.getStateColor("warning"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                                }
                                ]
                            }
                            ,
                        ...
                        var t = {
                            ...
                            data: {
                                labels: ["January",
                                    ...
                                    "October"],
                                datasets: [{
                                    label: "AdWord Clicks", backgroundColor: KTApp.getStateColor("brand"), borderColor: KTApp.getStateColor("brand"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [12, 16, 9, 18, 13, 12, 18, 12, 15, 17]
                                }
                                    ,
                                {
                                    label: "AdWords Views", backgroundColor: KTApp.getStateColor("success"), borderColor: KTApp.getStateColor("success"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                                }
                                ]
                            }
                            ,
                ...
                function () {
                    ...
                    (),
                e($("#kt_chart_quick_stats_1"), [10, 14, 18, 11, 9, 12, 14, 17, 18, 14], KTApp.getStateColor("brand"), 3),
                e($("#kt_chart_quick_stats_2"), [11, 12, 18, 13, 11, 12, 15, 13, 19, 15], KTApp.getStateColor("danger"), 3),
                e($("#kt_chart_quick_stats_3"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("success"), 3),
                e($("#kt_chart_quick_stats_4"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("success"), 3),
                function () {
                    var e = KTUtil.getByID("kt_chart_order_statistics");
                    if (e) {
                        var a = Chart.helpers.color,
                            t = {
                                labels: ["1 Jan",
                                    ...
                                    "7 Jan"],
                                datasets: [{
                                    fill: !0, backgroundColor: a(KTApp.getStateColor("brand")).alpha(.6).rgbString(), borderColor: a(KTApp.getStateColor("brand")).alpha(0).rgbString(), pointHoverRadius: 4, pointHoverBorderWidth: 12, pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("brand"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [20, 30, 20, 40, 30, 60, 30]
                                }
                                    ,
                                {
                                    fill: !0, backgroundColor: a(KTApp.getStateColor("brand")).alpha(.2).rgbString(), borderColor: a(KTApp.getStateColor("brand")).alpha(0).rgbString(), pointHoverRadius: 4, pointHoverBorderWidth: 12, pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: KTApp.getStateColor("brand"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [15, 40, 15, 30, 40, 30, 50]
                                }
                                ]
                            }
                            ,
                        ...
                        new Chart(i, {
                            type: "line", data: t, options: {
                                responsive: !0, maintainAspectRatio: !1, legend: !1, scales: {
                                    xAxes: [{
                                        categoryPercentage: .35, barPercentage: .7, display: !0, scaleLabel: {
                                            display: !1, labelString: "Month"
                                        }
                                        , gridLines: !1, ticks: {
                                            display: !0, beginAtZero: !0, fontColor: KTApp.getBaseColor("shape", 3), fontSize: 13, padding: 10
                                        }
                                    }
                                    ], yAxes: [{
                                        categoryPercentage: .35, barPercentage: .7, display: !0, scaleLabel: {
                                        ...
                                        , gridLines: {
                                            color: KTApp.getBaseColor("shape", 2), drawBorder: !1, offsetGridLines: !1, drawTicks: !1, borderDash: [3, 4], zeroLineWidth: 1, zeroLineColor: KTApp.getBaseColor("shape", 2), zeroLineBorderDash: [3, 4]
                                        }
                                        , ticks: {
                                            max: 70, stepSize: 10, display: !0, beginAtZero: !0, fontColor: KTApp.getBaseColor("shape", 3), fontSize: 13, padding: 10
                                        }
                                    }
                                    ]
                                }
                ...
                function () {
                    if (0 != $("#kt_dashboard_daterangepicker").length) {
                        var e = $("#kt_dashboard_daterangepicker"),
                            ...
                            t = moment();
                        e.daterangepicker({
                            direction: KTUtil.isRTL(), startDate: a, endDate: t, opens: "left", ranges: {
                    ...
                    function i(e, a, t) {
                        var i = "",
                            n = "";
                        a - e < 100 || "Today" == t ? (i = "Today:", n = e.format("MMM D")) : "Yesterday" == t ? (i = "Yesterday:", n = e.format("MMM D")) : n = e.format("MMM D") + " - " + a.format("MMM D"), $("#kt_dashboard_daterangepicker_date").html(n), $("#kt_dashboard_daterangepicker_title").html(i)
                    }
                }
                    (),
                0 !== $("#kt_datatable_latest_orders").length && $(".kt-datatable").KTDatatable({
                    data: {
                        type: "local", source: [{
                            ...
                            , {
                            RecordID: 141, OrderID: "55050-0011", Country: "Ghana", ShipCountry: "GH", ShipCity: "Kasoa", ShipName: "Predovic Inc", ShipAddress: "0926 American Drive", CompanyEmail: "crambaut3w@salon.com", CompanyAgent: "Candice Rambaut", CompanyName: "Skiles-Dicki", Currency: "GHS", Notes: "ligula in lacus curabitur at ipsum ac tellus semper interdum mauris ullamcorper purus sit", Department: "Toys", Website: "privacy.gov.au", Latitude: 5.5300711, Longitude: -.4408037, ShipDate: "3/25/2018", PaymentDate: "2017-07-31 08:09:34", TimeZone: "Africa/Accra", TotalPayment: "$425816.50", Status: 3, Type: 2, Actions: null
                        }
                            , {
                        ...
                        , serverPaging: !1, serverFiltering: !1, serverSorting: !1
                    }
                    , layout: {
                        scroll: !0, height: 500, footer: !1
                    }
                    , sortable: !0, filterable: !1, pagination: !0, columns: [{
                        ...
                        , {
                        field: "ShipName", title: "Company", width: "auto", autoHide: !1, template: function (e, a) {
                            for (var t = a + 1;
                                t > 5;
                            )t -= 3;
                            return '                        <div class="kt-user-card-v2">                            <div class="kt-user-card-v2__pic">                                <img src="assets/media/client-logos/logo' + t + '.png" alt="photo">                            </div>                            <div class="kt-user-card-v2__details">                                <a href="#" class="kt-user-card-v2__name">' + e.CompanyName + '</a>                                <span class="kt-user-card-v2__email">' + ["Angular, React", "Vue, Kendo", ".NET, Oracle, MySQL", "Node, SASS, Webpack", "MangoDB, Java", "HTML5, jQuery, CSS3"][t - 1] + "</span>                            </div>                        </div>"
                        }
                    }
                        , {
                        field: "ShipDate", title: "Date", width: 100, type: "date", format: "MM/DD/YYYY", template: function (e) {
                            return '<span class="kt-font-bold">' + e.ShipDate + "</span>"
                        }
                    }
                        , {
                        field: "Status", title: "Status", width: 100, template: function (e) {
                            var a = {
                                1: {
                                    title: "Pending", class: " btn-label-brand"
                                }
                                , 2: {
                                    title: "Processing", class: " btn-label-danger"
                                }
                                , 3: {
                                    title: "Success", class: " btn-label-success"
                                }
                                , 4: {
                                    title: "Delivered", class: " btn-label-success"
                                }
                                , 5: {
                                ...
                                ;
                            return '<span class="btn btn-bold btn-sm btn-font-sm ' + a[e.Status].class + '">' + a[e.Status].title + "</span>"
                        }
                    }
                        , {
                        field: "Type", title: "Managed By", width: 200, template: function (e, a) {
                            for (var t = 4 + a;
                                t > 12;
                            )t -= 3;
                            var i = "100_" + t + ".jpg", n = KTUtil.getRandomInt(0, 5), o = ["Developer", "Designer", "CEO", "Manager", "Architect", "Sales"];
                            return t > 5 ? '<div class="kt-user-card-v2">\t\t\t\t\t\t\t<div class="kt-user-card-v2__pic">\t\t\t\t\t\t\t\t<img src="assets/media/users/' + i + '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="kt-user-card-v2__details">\t\t\t\t\t\t\t\t<a href="#" class="kt-user-card-v2__name">' + e.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<span class="kt-user-card-v2__desc">' + o[n] + "</span>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>" : '<div class="kt-user-card-v2">\t\t\t\t\t\t\t<div class="kt-user-card-v2__pic">\t\t\t\t\t\t\t\t<div class="kt-badge kt-badge--xl kt-badge--' + ["success", "brand", "danger", "success", "warning", "primary", "info"][KTUtil.getRandomInt(0, 6)] + '">' + e.CompanyAgent.substring(0, 1) + '</div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="kt-user-card-v2__details">\t\t\t\t\t\t\t\t<a href="#" class="kt-user-card-v2__name">' + e.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<span class="kt-user-card-v2__desc">' + o[n] + "</span>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>"
                        }
                    }
                        , {
                        field: "Actions", width: 80, title: "Actions", sortable: !1, autoHide: !1, overflow: "visible", template: function () {
                        ...
                        e.format("YYYY-MM"),
                            ...
                            $("#kt_calendar").fullCalendar({
                                ...
                                , editable: !0, eventLimit: !0, navLinks: !0, defaultDate: moment("2017-09-15"), events: [{
                                    title: "Meeting", start: moment("2017-08-28"), description: "Lorem ipsum dolor sit incid idunt ut", className: "fc-event-light fc-event-solid-warning"
                                }
                                    , {
                                    title: "Conference", description: "Lorem ipsum dolor incid idunt ut labore", start: moment("2017-08-29T13:30:00"), end: moment("2017-08-29T17:30:00"), className: "fc-event-success"
                                }
                                    , {
                                    title: "Dinner", start: moment("2017-08-30"), description: "Lorem ipsum dolor sit tempor incid", className: "fc-event-light  fc-event-solid-danger"
                                }
                                    , {
                                    title: "All Day Event", start: moment("2017-09-01"), description: "Lorem ipsum dolor sit incid idunt ut", className: "fc-event-danger fc-event-solid-focus"
                                }
                                    , {
                                    title: "Reporting", description: "Lorem ipsum dolor incid idunt ut labore", start: moment("2017-09-03T13:30:00"), end: moment("2017-09-04T17:30:00"), className: "fc-event-success"
                                }
                                    , {
                                    title: "Company Trip", start: moment("2017-09-05"), end: moment("2017-09-07"), description: "Lorem ipsum dolor sit tempor incid", className: "fc-event-primary"
                                }
                                    , {
                                    title: "ICT Expo 2017 - Product Release", start: moment("2017-09-09"), description: "Lorem ipsum dolor sit tempor inci", className: "fc-event-light fc-event-solid-primary"
                                }
                                    , {
                                    title: "Dinner", start: moment("2017-09-12"), description: "Lorem ipsum dolor sit amet, conse ctetur"
                                }
                                    , {
                                    id: 999, title: "Repeating Event", start: moment("2017-09-15T16:00:00"), description: "Lorem ipsum dolor sit ncididunt ut labore", className: "fc-event-danger"
                                }
                                    , {
                                    id: 1e3, title: "Repeating Event", description: "Lorem ipsum dolor sit amet, labore", start: moment("2017-09-18T19:00:00")
                                }
                                    , {
                                    title: "Conference", start: moment("2017-09-20T13:00:00"), end: moment("2017-09-21T19:00:00"), description: "Lorem ipsum dolor eius mod tempor labore", className: "fc-event-success"
                                }
                                    , {
                                    title: "Meeting", start: moment("2017-09-11"), description: "Lorem ipsum dolor eiu idunt ut labore"
                                }
                                    , {
                                    title: "Lunch", start: moment("2017-09-18"), className: "fc-event-info fc-event-solid-success", description: "Lorem ipsum dolor sit amet, ut labore"
                                }
                                    , {
                                    title: "Meeting", start: moment("2017-09-24"), className: "fc-event-warning", description: "Lorem ipsum conse ctetur adipi scing"
                                }
                                    , {
                                    title: "Happy Hour", start: moment("2017-09-24"), className: "fc-event-light fc-event-solid-focus", description: "Lorem ipsum dolor sit amet, conse ctetur"
                                }
                                    , {
                                    title: "Dinner", start: moment("2017-09-24"), className: "fc-event-solid-focus fc-event-light", description: "Lorem ipsum dolor sit ctetur adipi scing"
                                }
                                    , {
                                    title: "Birthday Party", start: moment("2017-09-24"), className: "fc-event-primary", description: "Lorem ipsum dolor sit amet, scing"
                                }
                                    , {
                                    title: "Company Event", start: moment("2017-09-24"), className: "fc-event-danger", description: "Lorem ipsum dolor sit amet, scing"
                                }
                                    , {
                                    title: "Click for Google", url: "http://google.com/", start: moment("2017-09-26"), className: "fc-event-solid-info fc-event-light", description: "Lorem ipsum dolor sit amet, labore"
                                }
                                ], eventRender: function (e, a) {
                                    a.hasClass("fc-day-grid-event") ? (a.data("content", e.description), a.data("placement", "top"), KTApp.initPopover(a)) : a.hasClass("fc-time-grid-event") ? a.find(".fc-title").append('<div class="fc-description">' + e.description + "</div>") : 0 !== a.find(".fc-list-item-title").lenght && a.find(".fc-list-item-title").append('<div class="fc-description">' + e.description + "</div>")
                                }
                            }
                            )
                    }
                ...
                a.owlCarousel({
                    rtl: KTUtil.isRTL(), center: !0, loop: !0, items: 2
                }
                ),
                t.owlCarousel({
                    rtl: KTUtil.isRTL(), items: 1, animateIn: "fadeIn(100)", loop: !0
                }
                ),
            ...
            var i = new KTDialog({
                type: "loader", placement: "top center", message: "در حال بارگزاری ...."
            }
            );
            i.show(),
                setTimeout(function () {
